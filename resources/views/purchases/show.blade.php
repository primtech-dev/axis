...
@section('content')
                            ...
                            @foreach ($purchase->payments as $pay)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('purchases.payments.print', $pay->id) }}" target="_blank"
        ...
        <div class="card mb-3">
            ...
            <div class="card-body row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <div class="fw-bold">
                        {{ number_format($purchase->payable->total, 2, ',', '.') }}
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="fw-bold text-success">
                        {{ number_format($purchase->payable->paid, 2, ',', '.') }}
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="fw-bold text-danger">
                        {{ number_format($purchase->payable->balance, 2, ',', '.') }}
                    </div>
                </div>
    ...
    <div class="card">
        ...
        <div class="card-footer d-flex gap-2">
            ...
            <a href="{{ route('purchases.print', $purchase->id) }}" class="btn btn-outline-secondary" target="_blank">
                <i data-lucide="printer"></i> Print
            </a>

            {{-- future: bayar hutang --}}
            @if ($purchase->payment_type === 'CREDIT' && $purchase->status !== 'PAID')
                <a href="{{ route('purchases.pay.create', $purchase->id) }}" class="btn btn-success"
